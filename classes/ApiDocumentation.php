...
EOT;
     ...
     * @return bool True if documentation was generated successfully
     */
    public function generate(): bool
    {
        try {
            ...
            $filePath = self::DOCS_DIR . '/api.md';
            return file_put_contents($filePath, self::TEMPLATE) !== false;
        } catch (Exception $e) {
            error_log('Failed to generate API documentation: ' . $e->getMessage());
            return false;
        }
    }
} 